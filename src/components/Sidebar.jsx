  ...
  return (
    <>
      ...
      >
        ...
        {/* Logout — mobile slide-out only (on desktop it lives in the top bar) */}
        <div className="lg:hidden flex-shrink-0 border-t border-gray-200">
          <button
        ...
        <div className="p-4 border-t border-gray-200 flex-shrink-0">
          {/* Theme / quota / language — mobile slide-out only; on desktop these
              live in the top bar so the sidebar rail never needs to scroll. */}
